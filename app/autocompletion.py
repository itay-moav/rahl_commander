...
class SpDataParser:
    ...
    def comments(self):
        ...
        comments = "\t   /**\n"
        comments += "\t\t* Database: " + self.check_against_db + "\n"
    ...
    def __str__(self):
        ...
        self.prepareArgs()
        return "\n\n" + self.comments() + "\t\tpublic function {}_{}{}".format(self.check_against_db,self.sp_name,self.getArgsAsPHP()) + "{\n\t\t\t/*\n" + self.body.replace('END','') + "\n\t\t\t*/\n\t\t}\n"
