...
help = {'verbosity':        'By default, not specifying this will echo only the fatal errors. Specifying it -v to -vvvv will Show more',  \
        # deprecated option 'server_connection':'optional way to specifiy sql connection username:password@server.ip.or.domain',                  \
        # deprecated option 'assets_path':      'optional way to specify the assets full absolute path,starting from / (root folder)',            \
